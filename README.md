...
**v0.2.0 - User is able to see in the termianl the list of folders and files inside a given folder (path) and can see if the listed objects are files or folders!**
